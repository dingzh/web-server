...
public class RequestHandlerSharedQueueBusyWait implements Runnable {
    ...
    RequestHandlerSharedQueueBusyWait(Queue<Socket> connPool, int cacheSize, Monitor monitor, int timeout, HashMap<String, String> docRoots) {
