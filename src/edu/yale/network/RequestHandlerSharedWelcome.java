...
public class RequestHandlerSharedWelcome implements Runnable {
    ...
    RequestHandlerSharedWelcome(ServerSocket welcome, int cacheSize, Monitor monitor, int timeout, HashMap<String, String> docRoots) {
